    ...
    public boolean onCommand(CommandSender sender, Command command, String commandLabel, String[] args) {
        if (commandLabel.equalsIgnoreCase("party")) {
            ...
            if (args[0].equalsIgnoreCase("create")) {
                ...
                player.sendMessage(ChatColor.GOLD + "You have created party!");
            }
            ...
            if (args[0].equalsIgnoreCase("invite")) {
                ...
                if (!isOwner(player)) {
                    player.sendMessage(ChatColor.RED + "You are not the owner of this party!");
                    return false;
                }

                Player invitePlayer = Bukkit.getPlayer(args[1]);
                if (invitePlayer == null) {
                    player.sendMessage(ChatColor.RED + "Unable to find " + args[1] + "!");
                    return false;
                }
                ...
                partyObject.sendMessage(ChatColor.GOLD + invitePlayer.getName() + " has been invited to your party!");

                invitePlayer.sendMessage(ChatColor.GOLD + "You have been invited to " + player.getName() + "'s party! Type " + ChatColor.GREEN + "'/party accept' " + ChatColor.GOLD + "to accept.");
            }
            ...
            if (args[0].equalsIgnoreCase("accept")) {
                ...
                invite.party.sendMessage(ChatColor.GOLD + player.getName() + " has joined the party!");
            ...
            if (args[0].equalsIgnoreCase("leave")) {
                ...
                if (isOwner(player)) {
                    partyObject.sendMessage(ChatColor.GOLD + "The party has been disbanded by " + player.getName());
                ...
                partyObject.sendMessage(ChatColor.GOLD + player.getName() + " has left the party.");
            ...
            if (args[0].equalsIgnoreCase("kick")) {
                ...
                if (partyObject != getParty(invitePlayer)) {
                    player.sendMessage(ChatColor.RED + invitePlayer.getName() + " is not in your party!");
                    return false;
                }

                partyObject.sendMessage(ChatColor.GOLD + invitePlayer.getName() + " has been kicked from the party.");
