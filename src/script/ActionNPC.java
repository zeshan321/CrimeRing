        ...
        if (event.getRightClicked() instanceof LivingEntity) {
            ...
            if (interacted.getCustomName() == null) {
                if (Main.instance.scriptsManager.contains(typeNPC + event.getRightClicked().getType().name())) {
                    for (ScriptObject scriptObject : Main.instance.scriptsManager.getObjects(typeNPC + event.getRightClicked().getType().name())) {
            ...
            if (Main.instance.scriptsManager.contains(typeNPC + customName)) {
                for (ScriptObject scriptObject : Main.instance.scriptsManager.getObjects(typeNPC + customName)) {
